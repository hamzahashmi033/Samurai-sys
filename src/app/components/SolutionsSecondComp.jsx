...
const SolutionsSecondComp = () => {
  return (
    <div className="  2xl:mb-[200px] max-h-[100vh] lg:mb-[270px] md:mb-[100px]">
      <div className=" 2xl:w-[1728px] h-[100vh] pt-4 lg:mb-10   sm:w-[100vw]   mx-auto ">
        <div className="2xl:w-[1528px] mt-6 px-1     w-[85vw]  lg:shadow-xl mx-auto">
          ...
          <div className="2xl:max-w-[50vw] gap-8 flex xs:flex-col 2xl:mt-20 lg:flex-row w-[85vw]  mx-auto">
            <div className="mt-16 lg:max-w-[35vw] 2xl:max-w-[25vw] sm:mx-auto lg:mx-20 2xl:mx-4 ">
              {" "}
              <div className="flex gap-2  items-center">
                <p className="border border-[#725e5e] h-px w-[5rem] ml-2 block xl:block" />
                <p className="font-[300]    xs:text-[12px]  2xl:text-[20px]">
                  IT Infrastructure
                </p>
              </div>
              ...
              <div>
                <p className="mt-6 mb-6 xs:text-[14px] 2xl:text-[18px] font-[400]">
              ...
              <div className="mb-10">
                <button className="bg-Black text-White font-[600] xs:w-[85vw] sm:w-[auto] xs:rounded-lg  py-[10px] px-[42px]">
                  Start Project
                </button>
              </div>
            </div>
